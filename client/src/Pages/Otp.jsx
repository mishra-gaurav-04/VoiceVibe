    ...
    <div className='flex items-center justify-center my-24'>
      <Card title='Verification' icon={lockIcon}>
        <div className='mt-4 p-2'>
            <input type="text"  className='text-center bg-transparent focus:outline-none border-b-2 focus:border-blue-600 ' maxLength={4} inputMode='numeric' placeholder='Enter Your OTP' required/>
        </div>
