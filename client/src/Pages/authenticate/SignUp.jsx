              ...
              <div className='mt-4'>                                      
                    <form>
                      ...
                      <div class="relative max-w-sm">
                          ...
                          <input datepicker datepicker-orientation="bottom right" type="date" name='dateofbirth' class="bg-gray-500 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date of birth"/>
                    </div>
                      <div className='mt-4 ml-2 flex gap-3'>
                        <input type="checkbox"  id='terms_conditions' className=''/>
                        <label htmlFor="terms_conditions" >I agree to Terms and Conditions</label>
                      </div>
                    </form>
